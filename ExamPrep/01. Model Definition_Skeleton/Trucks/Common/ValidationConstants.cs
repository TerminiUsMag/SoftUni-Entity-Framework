...
namespace Trucks.Common
{
    public class ValidationConstants
    {
        ...
        public const int EnumCategoryTypeMinValue = 0;
        public const int EnumCategoryTypeMaxValue = 3;
        public const int EnumMakeTypeMinValue = 0;
        public const int EnumMakeTypeMaxValue = 4;
